...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Scroll horizontal sections to start on mobile
...
// ============= MOBILE TOUCH SUPPORT FOR HORIZONTAL SCROLL =============
...
function scrollToFirstCardOnMobile() {
    ...
    // Scroll to first card with a slight delay to ensure DOM is ready
    setTimeout(() => {
        if (armoryScroll) {
...
// Also scroll to first card when window resizes to mobile
